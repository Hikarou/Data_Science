...
\pagebreak
\section{Partie 3}
    Pour la partie 3, nous avons décidé de partie sur les données suivantes : \href{https://archive.ics.uci.edu/ml/datasets/Letter+Recognition}{``Letter Image Recognition Data''}, donc la reconnaissance de lettres par caractéristiques d'image.
