...
\section{Partie 3}
    ...
    Le perceptron travaille longtemps pour un résultat pas très probant (0.66), ensuite l'arbre de décision (~0.73) et le meilleur résultat revient à la méthode des K-plus proches voisins.
\end{document}
